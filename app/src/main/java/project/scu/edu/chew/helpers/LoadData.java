...
public class LoadData {
    ...
    public static void populateData(List<HomeCook> homeCooks) {
        ...
        FoodItem foodItem = new FoodItem("Pizza", "food1.jpg");
        ...
        foodItem = new FoodItem("Pasta", "food1.jpg");
        foodItem.setDescription("Ziti, Prosciutto, Asiago Cheese & Red Pepper Cream Sauce");
        homeCook.getFoodItems().add(foodItem);

        foodItem = new FoodItem("Lasagne", "food1.jpg");
        ...
        foodItem = new FoodItem("Tiramisu", "food1.jpg");
        ...
        foodItem = new FoodItem("Chicken Parmigiana", "food1.jpg");
        ...
        foodItem = new FoodItem("Macaroni & Cheese", "food1.jpg");
        ...
        foodItem = new FoodItem("Dosa", "dosa.jpg");
        ...
        foodItem = new FoodItem("Rice and Curry", "rice_and_curry.jpg");
        ...
        foodItem = new FoodItem("Daal", "daal.jpg");
        ...
        foodItem = new FoodItem("Chicken Tikka Masala", "chickentikka_masala.jpg");
        ...
        foodItem = new FoodItem("Chicken Biryani", "chicken_biryani.jpg");
        ...
        homeCook.setLargeImage("wangs_kitchen.jpg");
        homeCook.setCuisine("Chinese");
        homeCook.setAddress("438 Barber Lane, Milpitas, CA 95035");
        homeCook.setTime("11:30 am to 10:00 pm");

        // Food Item1
        foodItem = new FoodItem("Manchow soup", "manchow_soup.jpg");
        ...
        // Food Item2
        foodItem = new FoodItem("Chicken Wonton Soup", "wonton_soup.jpg");
        ...
        // Food Item3
        foodItem = new FoodItem("Chicken spring roll", "spring_roll.jpg");
        ...
        // Food Item5
        foodItem = new FoodItem("Chicken Sizzler", "sizzler.jpg");
        ...
        // Food Item6
        foodItem = new FoodItem("Szechwan fried rice", "sfried_rice.jpg");
        ...
        // Food Item7
        foodItem = new FoodItem("Hakka noodles", "hakka_noodles.jpg");
        ...
        // Food Item8
        foodItem = new FoodItem("Lo-Mein", "chowmein.jpg");
        ...
        homeCook.setLargeImage("berta_kitchen.jpg");
...
//1st
        foodItem = new FoodItem("Doro Wot", "doro_wot.jpg");
...
//2nd
        foodItem = new FoodItem("Doro Tibbs", "doro_tibs.jpg");
...
//3rd
        foodItem = new FoodItem("Zilzil Tibbs", "zilzil_tibs.jpg");
...
//4th
        foodItem = new FoodItem("Yebeg Tibbs", "yebeg_tibs.jpg");
...
//5th
        foodItem = new FoodItem("Yemisser Wot", "yemesir_wot.jpg");
...
//6th
        foodItem = new FoodItem("Gomen Wot", "gomen_wot.jpg");
...
//7th
        foodItem = new FoodItem("Sambussa", "sambussa.jpg");
...
//8th
        foodItem = new FoodItem("Ethiopian Pastries", "ethiopian_pastries.jpg");
